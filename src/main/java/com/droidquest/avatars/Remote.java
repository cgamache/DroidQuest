...
import static com.droidquest.avatars.Keyboard.isControlDown;
...
public class Remote extends Item implements Avatar {
	...
	public boolean KeyUp(KeyEvent e) {
		if (e.getKeyCode() == KeyEvent.VK_S) {
			...
			if (carriedBy == null) {
				moveRight(isControlDown(e));
			}
			repeating = 0;
			return true;
		} else if (e.getKeyCode() == KeyEvent.VK_LEFT) {
			if (carriedBy == null) {
				moveLeft(isControlDown(e));
			}
			repeating = 0;
			return true;
		} else if (e.getKeyCode() == KeyEvent.VK_UP) {
			if (carriedBy == null) {
				moveUp(isControlDown(e));
			}
			repeating = 0;
			return true;
		} else if (e.getKeyCode() == KeyEvent.VK_DOWN) {
			if (carriedBy == null) {
				moveDown(isControlDown(e));
			}
			repeating = 0;
			return true;
