...
import static com.droidquest.avatars.Keyboard.*;
...
public class Player extends Item implements Avatar {
    ...
    public boolean KeyUp(KeyEvent e) {
        ...
        else if (e.getKeyCode() == KeyEvent.VK_RIGHT && handleMoveRight(e.isShiftDown(), isControlDown(e))) {
            return true;
        }
        else if (e.getKeyCode() == KeyEvent.VK_LEFT && handleMoveLeft(e.isShiftDown(), isControlDown(e))) {
            return true;
        }
        else if (e.getKeyCode() == KeyEvent.VK_UP && handleMoveUp(e.isShiftDown(), isControlDown(e))) {
            return true;
        }
        else if (e.getKeyCode() == KeyEvent.VK_DOWN && handleMoveDown(e.isShiftDown(), isControlDown(e))) {
            return true;
        }
    ...
    public boolean KeyDown(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_RIGHT) {
            if (handleRepeatRight(isControlDown(e))) {
                return true;
            }
        }
        else if (e.getKeyCode() == KeyEvent.VK_LEFT) {
            if (handleRepeatLeft(isControlDown(e))) {
                return true;
            }
        }
        else if (e.getKeyCode() == KeyEvent.VK_UP) {
            if (handleRepeatUp(isControlDown(e))) {
                return true;
            }
        }
        else if (e.getKeyCode() == KeyEvent.VK_DOWN) {
            if (handleRepeatDown(isControlDown(e))) {
                return true;
            }
        }
